...
export const TeamBlock: React.FC<TeamBlockProps> = (props) => {
  ...
  return (
    <section className="bg-white py-12 md:py-16 lg:py-24 px-4 md:px-6 lg:px-8">
      <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
        {members.map((member) => (
          <div key={member.id} className="flex flex-col gap-6 md:gap-8 group">
            {/* Member Photo */}
            ...
            {/* Member Name */}
            <h4 className="font-semibold text-lg md:text-xl lg:text-2xl leading-tight">
              {member.name}
            </h4>
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="flex-shrink-0">
                    <svg
                      ...
                      className="border border-gray-300 p-1.5 md:p-2 size-7 md:size-8 rounded"
                    >
                      <path
