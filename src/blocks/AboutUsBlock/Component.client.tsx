...
export const AboutUsBlockClient: React.FC<AboutUsBlockProps> = (props) => {
      ...
      <div className="container">
        <div className="flex justify-between flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex justify-between flex-col lg:min-h-[690px] lg:max-w-2xl w-full lg:w-auto">
            ...
            <div
              ref={counterRef}
              className="flex flex-col sm:flex-row gap-8 sm:gap-16 lg:gap-32 mb-8 lg:mb-0"
            >
          ...
          {/* Media Grid - Your exact original layout */}
          <div className="w-full lg:w-auto">
            ...
            {/* Desktop Layout - Two Column Grid with Parallax */}
            <div className="hidden lg:grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-end gap-8">
                <motion.div style={{ y: rightImage1Y }}>
                  <Media
                ...
                <motion.div style={{ y: rightImage2Y }}>
                  <Media
...
const CounterAnimation: React.FC<{
  ...
  isInView: boolean
  delay: number
}> = ({ number, label, overflow, isInView, delay }) => {
  ...
  return (
    <div className="flex flex-col items-center sm:items-start lg:items-center text-center sm:text-left lg:text-center">
      ...
      <div className="text-base sm:text-lg lg:text-xl uppercase mt-2">{label}</div>
    </div>
  )
}
