// components/AnimatedProductHero.tsx
'use client'
...
interface AnimatedProductHeroProps {
  product: Product
}

export function AnimatedProductHero({ product }: AnimatedProductHeroProps) {
  ...
  return (
    <section ref={sectionRef} className="relative container py-16 md:py-24">
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight tracking-tight uppercase"
            >
              {product.title}
            </motion.h1>
